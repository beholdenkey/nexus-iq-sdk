...
class ApiFirewallQuarantineSummaryDTO(object):
    ...
    def __init__(self, repository_count=None, quarantine_enabled_repository_count=None, quarantine_enabled=None, total_component_count=None, quarantined_component_count=None):  # noqa: E501
        ...
        if quarantine_enabled_repository_count is not None:
            self.quarantine_enabled_repository_count = quarantine_enabled_repository_count
