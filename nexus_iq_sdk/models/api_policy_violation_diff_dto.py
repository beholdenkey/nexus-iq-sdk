...
class ApiPolicyViolationDiffDTO(object):
    ...
    def __init__(self, application=None, from_commit=None, to_commit=None, diff_time=None, added_violations=None, same_violations=None, removed_violations=None):  # noqa: E501
