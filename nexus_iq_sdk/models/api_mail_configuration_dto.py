...
class ApiMailConfigurationDTO(object):
    ...
    def __init__(self, hostname=None, port=None, username=None, password=None, password_is_included=None, ssl_enabled=None, start_tls_enabled=None, system_email=None):  # noqa: E501
