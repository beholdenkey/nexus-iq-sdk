...
class ApiSecurityIssueDTO(object):
    ...
    def __init__(self, source=None, reference=None, severity=None, status=None, url=None, threat_category=None, cwe=None, cvss_vector=None, cvss_vector_source=None):  # noqa: E501
