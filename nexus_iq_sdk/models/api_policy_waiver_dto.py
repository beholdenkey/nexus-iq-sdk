...
class ApiPolicyWaiverDTO(object):
    ...
    def __init__(self, policy_waiver_id=None, policy_violation_id=None, comment=None, create_time=None, expiry_time=None, is_obsolete=None, scope_owner_type=None, scope_owner_id=None, scope_owner_name=None, hash=None, policy_id=None, vulnerability_id=None, policy_name=None, constraint_facts=None, constraint_facts_json=None, component_name=None, creator_id=None, creator_name=None, matcher_strategy=None, associated_package_url=None, component_identifier=None, threat_level=None, display_name=None):  # noqa: E501
    ...
    def matcher_strategy(self, matcher_strategy):
        ...
        :type: str
        """
        allowed_values = ["DEFAULT", "EXACT_COMPONENT", "ALL_COMPONENTS", "ALL_VERSIONS"]  # noqa: E501
        if matcher_strategy not in allowed_values:
            raise ValueError(
                "Invalid value for `matcher_strategy` ({0}), must be one of {1}"  # noqa: E501
                .format(matcher_strategy, allowed_values)
            )
