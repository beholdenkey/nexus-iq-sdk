...
class AttributionReportTemplateDTO(object):
    ...
    def __init__(self, id=None, template_name=None, document_title=None, header=None, footer=None, include_table_of_contents=None, include_appendix=None, include_standard_license_texts=None, include_sonatype_special_licenses=None, last_updated_at=None, include_inner_source=None):  # noqa: E501
