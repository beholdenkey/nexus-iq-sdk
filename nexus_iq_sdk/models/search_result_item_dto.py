...
class SearchResultItemDTO(object):
    ...
    def __init__(self, item_type=None, organization_id=None, organization_name=None, application_id=None, application_public_id=None, application_name=None, policy_evaluation_stage=None, report_id=None, component_hash=None, component_identifier=None, component_name=None, vulnerability_id=None, vulnerability_description=None, vulnerability_status=None, application_category_id=None, application_category_name=None, application_category_color=None, application_category_description=None, component_label_id=None, component_label_name=None, component_label_color=None, component_label_description=None, policy_id=None, policy_name=None, policy_threat_category=None, policy_threat_level=None, result_index=None):  # noqa: E501
