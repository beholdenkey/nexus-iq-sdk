...
class ApiLicenseLegalMetadataDTO(object):
    ...
    def __init__(self, license_id=None, license_name=None, license_text=None, obligations=None, threat_group=None, is_multi=None, single_license_ids=None):  # noqa: E501
