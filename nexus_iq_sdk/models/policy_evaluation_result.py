...
class PolicyEvaluationResult(object):
    ...
    def __init__(self, alerts=None, affected_component_count=None, critical_component_count=None, severe_component_count=None, moderate_component_count=None, critical_policy_violation_count=None, severe_policy_violation_count=None, moderate_policy_violation_count=None, grandfathered_policy_violation_count=None, total_component_count=None):  # noqa: E501
        ...
        if grandfathered_policy_violation_count is not None:
            self.grandfathered_policy_violation_count = grandfathered_policy_violation_count
    ...
    def grandfathered_policy_violation_count(self, grandfathered_policy_violation_count):
        ...
        self._grandfathered_policy_violation_count = grandfathered_policy_violation_count
