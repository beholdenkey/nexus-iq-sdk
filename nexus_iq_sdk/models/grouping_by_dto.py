...
class GroupingByDTO(object):
    ...
    def __init__(self, group_identifier=None, group_by=None, additional_info=None, search_result_item_dtos=None):  # noqa: E501
    ...
    def group_identifier(self, group_identifier):
        ...
        :type: str
        """
        allowed_values = ["itemType", "organizationId", "organizationName", "applicationId", "applicationName", "applicationPublicId", "policyEvaluationStage", "reportId", "componentHash", "componentFormat", "componentName", "componentCoordinate", "vulnerabilityId", "vulnerabilitySeverity", "vulnerabilityStatus", "vulnerabilityDescription", "applicationCategoryId", "applicationCategoryName", "applicationCategoryColor", "applicationCategoryDescription", "componentLabelId", "componentLabelName", "componentLabelColor", "componentLabelDescription", "policyId", "policyName", "policyThreatCategory", "policyThreatLevel"]  # noqa: E501
        if group_identifier not in allowed_values:
            raise ValueError(
                "Invalid value for `group_identifier` ({0}), must be one of {1}"  # noqa: E501
                .format(group_identifier, allowed_values)
            )
