...
class SearchResultDTO(object):
    ...
    def __init__(self, search_query=None, page=None, page_size=None, total_number_of_hits=None, is_exact_total_number_of_hits=None, grouping_by_dtos=None):  # noqa: E501
