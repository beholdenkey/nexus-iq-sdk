...
class ApiSourceControlConfigurationDTO(object):
    ...
    def __init__(self, clone_directory=None, git_implementation=None, pr_comment_purge_window=None, pr_event_purge_window=None, git_executable=None, git_timeout_seconds=None, commit_username=None, commit_email=None, use_username_in_repository_clone_url=None, default_branch_monitoring_start_time=None, default_branch_monitoring_interval_hours=None, pull_request_monitoring_interval_seconds=None):  # noqa: E501
        ...
        if use_username_in_repository_clone_url is not None:
            self.use_username_in_repository_clone_url = use_username_in_repository_clone_url
        if default_branch_monitoring_start_time is not None:
            self.default_branch_monitoring_start_time = default_branch_monitoring_start_time
        if default_branch_monitoring_interval_hours is not None:
            self.default_branch_monitoring_interval_hours = default_branch_monitoring_interval_hours
        if pull_request_monitoring_interval_seconds is not None:
            self.pull_request_monitoring_interval_seconds = pull_request_monitoring_interval_seconds
    ...
    def git_implementation(self, git_implementation):
        ...
        if git_implementation not in allowed_values:
            raise ValueError(
                "Invalid value for `git_implementation` ({0}), must be one of {1}"  # noqa: E501
                .format(git_implementation, allowed_values)
            )
    ...
    def use_username_in_repository_clone_url(self, use_username_in_repository_clone_url):
        ...
        self._use_username_in_repository_clone_url = use_username_in_repository_clone_url
    ...
    def default_branch_monitoring_start_time(self, default_branch_monitoring_start_time):
        ...
        self._default_branch_monitoring_start_time = default_branch_monitoring_start_time
    ...
    def default_branch_monitoring_interval_hours(self, default_branch_monitoring_interval_hours):
        ...
        self._default_branch_monitoring_interval_hours = default_branch_monitoring_interval_hours
    ...
    def pull_request_monitoring_interval_seconds(self, pull_request_monitoring_interval_seconds):
        ...
        self._pull_request_monitoring_interval_seconds = pull_request_monitoring_interval_seconds
