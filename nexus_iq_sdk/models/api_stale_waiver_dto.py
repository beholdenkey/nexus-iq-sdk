...
class ApiStaleWaiverDTO(object):
    ...
    def __init__(self, waiver_id=None, policy_id=None, policy_name=None, comment=None, scope_owner_type=None, scope_owner_id=None, scope_owner_name=None, create_time=None, expiry_time=None, creator_id=None, creator_name=None, constraint_facts=None, stale_evaluations=None):  # noqa: E501
