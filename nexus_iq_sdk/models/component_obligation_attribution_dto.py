...
class ComponentObligationAttributionDTO(object):
    ...
    def __init__(self, id=None, component_identifier=None, package_url=None, owner_id=None, obligation_name=None, content=None, last_updated_at=None, last_updated_by_username=None):  # noqa: E501
