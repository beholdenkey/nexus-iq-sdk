...
class ApiLicenseLegalObligationDTO(object):
    ...
    def __init__(self, id=None, name=None, status=None, comment=None, component_identifier=None, package_url=None, owner_id=None, last_updated_at=None, last_updated_by_username=None):  # noqa: E501
