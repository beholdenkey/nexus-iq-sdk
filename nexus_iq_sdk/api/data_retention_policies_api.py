...
class DataRetentionPoliciesApi(object):
    ...
    def get_data_retention_policies(self, organization_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_data_retention_policies_with_http_info(organization_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_data_retention_policies_with_http_info(organization_id, **kwargs)  # noqa: E501
            return data

    def get_data_retention_policies_with_http_info(self, organization_id, **kwargs):  # noqa: E501
        """get_data_retention_policies  # noqa: E501
        ...
        if ('organization_id' not in params or
            ...
            raise ValueError("Missing the required parameter `organization_id` when calling `get_data_retention_policies`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/dataRetentionPolicies/organizations/{organizationId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def set_data_retention_policies(self, organization_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.set_data_retention_policies_with_http_info(organization_id, **kwargs)  # noqa: E501
        else:
            (data) = self.set_data_retention_policies_with_http_info(organization_id, **kwargs)  # noqa: E501
            return data

    def set_data_retention_policies_with_http_info(self, organization_id, **kwargs):  # noqa: E501
        """set_data_retention_policies  # noqa: E501
        ...
        if ('organization_id' not in params or
                params['organization_id'] is None):
            raise ValueError("Missing the required parameter `organization_id` when calling `set_data_retention_policies`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/dataRetentionPolicies/organizations/{organizationId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
