...
class VulnerabilitiesApi(object):
    ...
    def get_security_vulnerability_details(self, ref_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_security_vulnerability_details_with_http_info(ref_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_vulnerability_details_with_http_info(ref_id, **kwargs)  # noqa: E501
            return data

    def get_security_vulnerability_details_with_http_info(self, ref_id, **kwargs):  # noqa: E501
        """get_security_vulnerability_details  # noqa: E501
        ...
        all_params = ['ref_id', 'component_identifier', 'identification_source', 'scan_id', 'owner_type', 'owner_id']  # noqa: E501
        ...
        if ('ref_id' not in params or
            ...
            raise ValueError("Missing the required parameter `ref_id` when calling `get_security_vulnerability_details`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/vulnerabilities/{refId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
