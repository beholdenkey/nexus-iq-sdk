...
class ConfigApi(object):
    ...
    def disable_feature(self, feature, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.disable_feature_with_http_info(feature, **kwargs)  # noqa: E501
            return data
    ...
    def disable_feature_with_http_info(self, feature, **kwargs):  # noqa: E501
        ...
        if ('feature' not in params or
            ...
            raise ValueError("Missing the required parameter `feature` when calling `disable_feature`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/config/features/{feature}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def enabled_feature(self, feature, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.enabled_feature_with_http_info(feature, **kwargs)  # noqa: E501
            return data
    ...
    def enabled_feature_with_http_info(self, feature, **kwargs):  # noqa: E501
        ...
        if ('feature' not in params or
                params['feature'] is None):
            raise ValueError("Missing the required parameter `feature` when calling `enabled_feature`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/config/features/{feature}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
