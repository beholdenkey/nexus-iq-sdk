...
class SourceControlMetricsApi:
    ...
    def get_source_control(self, owner_type, internal_owner_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_source_control_with_http_info(
                owner_type, internal_owner_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_source_control_with_http_info(
                owner_type, internal_owner_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_source_control_with_http_info(
        ...
        if 'owner_type' not in params or params['owner_type'] is None:
            raise ValueError(
                'Missing the required parameter `owner_type` when calling `get_source_control`'
            )  # noqa: E501
        ...
        if 'internal_owner_id' not in params or params['internal_owner_id'] is None:
            raise ValueError(
                'Missing the required parameter `internal_owner_id` when calling `get_source_control`'
            )  # noqa: E501
