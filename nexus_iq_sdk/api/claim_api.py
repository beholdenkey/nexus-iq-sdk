...
class ClaimApi(object):
    ...
    def delete_with_http_info(self, hash, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/claim/components/{hash}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_with_http_info(self, hash, **kwargs):  # noqa: E501
        ...
        if ('hash' not in params or
                params['hash'] is None):
            raise ValueError("Missing the required parameter `hash` when calling `get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/claim/components/{hash}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
